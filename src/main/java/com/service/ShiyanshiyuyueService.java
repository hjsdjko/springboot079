...
public interface ShiyanshiyuyueService extends IService<ShiyanshiyuyueEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ShiyanshiyuyueEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ShiyanshiyuyueEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ShiyanshiyuyueEntity> wrapper);
